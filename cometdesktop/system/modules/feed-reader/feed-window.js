...
QoDesk.FeedWindow = function() {
    ...
    QoDesk.FeedWindow.superclass.constructor.call(this, {
        title: 'Add Feed',
        iconCls: 'feed-icon',
        id: 'add-feed-win',
        autoHeight: true,
...
Ext.extend(QoDesk.FeedWindow, Ext.Window, {
    defaultFeeds : [
        ['http://xantus.vox.com/library/posts/rss-full.xml', 'David Davis\' Blog'],
        ['http://rss.slashdot.org/Slashdot/slashdot', 'Slashdot'],
        ['http://feeds.gawker.com/gizmodo/excerpts.xml', 'Gizmodo'],
    ...
    show : function(){
        ...
        QoDesk.FeedWindow.superclass.show.apply(this, arguments);
    },
