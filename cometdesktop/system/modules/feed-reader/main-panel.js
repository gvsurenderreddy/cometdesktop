...
QoDesk.MainPanel = function(){
    this.preview = new Ext.Panel({
        id: 'preview',
        region: 'south',
        cls:'preview',
        autoScroll: true,
        listeners: QoDesk.FeedViewer.LinkInterceptor,
    ...
    this.grid = new QoDesk.FeedGrid(this, {
        tbar:[{
            text:'Open All',
    ...
    QoDesk.MainPanel.superclass.constructor.call(this, {
        id:'main-tabs',
        activeTab:0,
        region:'center',
        margins:'0 0 0 0',
    ...
    this.gsm.on('rowselect', function(sm, index, record){
        QoDesk.FeedViewer.getTemplate().overwrite(this.preview.body, record.data);
...
Ext.extend(QoDesk.MainPanel, Ext.TabPanel, {
    ...
    openTab : function(record){
        ...
        if(!(tab = this.getItem(id))){
            tab = new Ext.Panel({
                ...
                title: d.title,
                tabTip: d.title,
                html: QoDesk.FeedViewer.getTemplate().apply(d),
                closable:true,
                listeners: QoDesk.FeedViewer.LinkInterceptor,
                autoScroll:true,
                border:true,
