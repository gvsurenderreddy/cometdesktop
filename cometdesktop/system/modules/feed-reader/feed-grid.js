...
QoDesk.FeedGrid = function(viewer, config) {
    this.viewer = viewer;
    ...
    QoDesk.FeedGrid.superclass.constructor.call(this, {
        region: 'center',
        id: 'topic-grid',
...
Ext.extend(QoDesk.FeedGrid, Ext.grid.GridPanel, {
    ...
    loadFeed : function(url) {
        this.store.baseParams.what = url;
        this.store.load();
    },
